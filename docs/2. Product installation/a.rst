...
8.2. M2 Motor is connected to B interface,，M3 Motor is connected to A
interface.
...
8.3. M1 Motor is connected to B1 interface，M4 Motor is connected to A1
interface.
...
.. figure:: ./media/A49.png
   :alt: Img

   Img

.. |image1| image:: ./media/A17.png
.. |image2| image:: ./media/A18.png
