...
For driver installation, you can skip this step initially, as drivers
typically install automatically when the development board is connected
to your computer. If the board fails to be recognized after connection,
refer to this section to install the drivers.
...
5. Click\ |image-20250417085312966|\ to upload code and show “Done
   uploading”.
...
.. |image4| image:: ./media/20250626154343.png
